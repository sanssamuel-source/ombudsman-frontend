    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 text-white p-4">
      <div className="max-w-4xl w-full text-center space-y-8">
        ...
        <p className="text-xl text-slate-300 max-w-2xl mx-auto">
          A secure, transparent platform for the citizens of Sierra Leone to report public service issues and track their resolution.
        </p>
        <p className="text-lg text-slate-300 max-w-2xl mx-auto">
          You can also file a complaint via SMS and receive updates directly on your phone.
        </p>
