...
import { LogOut, RefreshCw, Filter, FileText } from 'lucide-react';
                    ...
                    <div className="flex items-center space-x-4">
                        <button onClick={() => {
                            const csvContent = "data:text/csv;charset=utf-8," 
                                + "Ref ID,Ministry,Date,Status\n"
                                + complaints.map(c => `${c.reference_id},${c.ministry},${new Date(c.created_at).toLocaleDateString()},${c.status}`).join("\n");
                            ...
                            link.click();
                        }} className="p-2 hover:bg-slate-100 rounded-lg text-green-600 transition-colors flex items-center">
                            <FileText className="w-5 h-5 mr-1" /> Export Excel
                        </button>
        ...
        <div className="min-h-screen bg-slate-100 p-6">
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <div className="grid md:grid-cols-4 gap-6">
                    ...
                    {/* Complaints List */}
                    <div className="md:col-span-4 bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                        <div className="p-6 border-b border-slate-200 flex justify-between items-center">
                            <h2 className="text-lg font-bold text-slate-800">Recent Complaints</h2>
                            <div className="flex items-center space-x-2">
                                <Filter className="w-4 h-4 text-slate-500" />
