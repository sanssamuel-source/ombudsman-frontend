...
const AdminDashboard = () => {
    ...
    const chartData = analytics ? Object.entries(analytics.by_status).map(([name, value]) => ({ name, value })) : [];
        ...
        <div className="min-h-screen bg-slate-100 p-6">
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <div className="grid md:grid-cols-4 gap-6">
                    ...
                    {/* Chart */}
                    <div className="md:col-span-3 bg-white p-6 rounded-xl shadow-sm border border-slate-200 h-64">
